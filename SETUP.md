...
- ✅ `app/api/chat/route.ts` (line 45 should have `gemini-1.5-pro`)
- ✅ `app/api/ai-tutor/route.ts` (line 46 should have `gemini-1.5-pro`)
- ✅ `app/api/generate-scenario/route.ts` (line 53 should have `gemini-1.5-pro`)

## Model Information

Current model: **gemini-1.5-pro**
- Latest Gemini model
- Supports advanced conversations
