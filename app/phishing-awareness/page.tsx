        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="bg-gray-800 rounded-lg shadow-lg p-8">
            ...
            <div className="bg-gray-50 dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 rounded-lg p-6 mb-4">
              <div className="space-y-2 text-sm text-gray-900 dark:text-white">
                ...
                <p className="mt-2">
                  <a href="#" className="text-blue-400 dark:text-blue-300 underline">https://paypal-verify-account.com/secure/login</a>
                </p>
                <p className="mt-2">
          ...
          <div className="bg-gray-800 rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6 text-center">
              Select a mode to reinforce what you've learned
            </p>
